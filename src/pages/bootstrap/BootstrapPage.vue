<template>
    <div class="q-pa-lg">
        ...
        >
            ...
            <div class="q-mb-md">{{ $t('settings.idDescription') }} <a href="https://t.me/corps_statistics_bot" target="_blank" rel="noopener noreferrer">https://t.me/corps_statistics_bot</a></div>
