<template>
    <div class="q-pa-lg">
        ...
        >
            ...
            <div class="q-mb-md">{{ $t('settings.idDescription') }} <a href="https://github.com/corpus-dev/cyberowl/blob/main/statistics.md" target="_blank" rel="noopener noreferrer">https://github.com/corpus-dev/cyberowl/blob/main/statistics.md</a></div>
